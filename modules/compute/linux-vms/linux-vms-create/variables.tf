...
variable "admin_ssh_key" {
  description = "The SSH public key of the local administrator to be created on the virtual machine"
  type        = string
  default     = null
}
...
variable "allow_extension_operations" {
  description = "Whether to allow extension operations for the virtual machine"
  type        = bool
  default     = true
}
