...
module "file_endpoint" {
  ...
  location                       = try(var.global_settings.location, module.resource_group[each.value.resource_group_name].location, module.resource_group_existing[each.value.resource_group_name].location, each.value.location)
  subnet_id                      = try(each.value.subnet_id, module.subnets[each.value.pe_subnet].id, module.subnets_existing[each.value.pe_subnet].id)
  private_dns_zone_ids           = [try(module.dns["privatelink.file.core.windows.net"].id, module.dns_existing["privatelink.file.core.windows.net"].id, module.dns_existing_remote["privatelink.file.core.windows.net"].id, module.dns_existing_remote2["privatelink.file.core.windows.net"].id, module.dns_existing_remote3["privatelink.file.core.windows.net"].id, module.dns["privatelink.file.core.usgovcldoudapi.net"].id, module.dns_existing["privatelink.file.core.usgovcldoudapi.net"].id, module.dns_existing_remote["privatelink.file.core.usgovcldoudapi.net"].id, module.dns_existing_remote2["privatelink.file.core.usgovcldoudapi.net"].id, module.dns_existing_remote3["privatelink.file.core.usgovcldoudapi.net"].id)]
  private_connection_resource_id = module.storage_account[each.key].id
